...
public class DatabaseAdapter {
	...
	public int updateName(String oldName, String newName){
		...
		ct.put(VivzHelper.NAME, newName);//Name='vivz'
		ct.put(VivzHelper.PASSWORD, newName);//Name='vivz'
		String[] whereArgs={oldName, "luis"};//Name='test'
		int count=db.update(VivzHelper.TABLE_NAME, ct, VivzHelper.NAME + " =? AND " + VivzHelper.PASSWORD + " =?", whereArgs);
		return count;
	}
	
	public int deleteName(String oldName, String password){
		//DELETE * FROM VIVZTABLE where Name='vivz'
		SQLiteDatabase db =helper.getWritableDatabase();
		String[] whereArgs={oldName, password};//Name='test'
		int count=db.delete(VivzHelper.TABLE_NAME, VivzHelper.NAME + " =? AND " + VivzHelper.PASSWORD + " =?", whereArgs);
		return count;
	}
